...
pub struct FPDF_FILEHANDLER_ {
    ...
    pub Release:
        ::std::option::Option<extern "C" fn(clientData: *mut ::std::os::raw::c_void)>,
    #[doc = " Callback function to retrieve the current file stream size.\n\n Parameters:\n       clientData   -  Pointer to user-defined data.\n Returns:\n       Size of file stream."]
    pub GetSize: ::std::option::Option<
        extern "C" fn(clientData: *mut ::std::os::raw::c_void) -> FPDF_DWORD,
    >,
    ...
    pub Flush: ::std::option::Option<
        extern "C" fn(clientData: *mut ::std::os::raw::c_void) -> FPDF_RESULT,
    >,
...
pub struct _IPDF_JsPlatform {
    ...
    pub app_beep: ::std::option::Option<
        extern "C" fn(pThis: *mut _IPDF_JsPlatform, nType: ::std::os::raw::c_int),
    >,
    ...
    pub Doc_gotoPage: ::std::option::Option<
        extern "C" fn(pThis: *mut _IPDF_JsPlatform, nPageNum: ::std::os::raw::c_int),
    >,
...
pub type TimerCallback =
    ::std::option::Option<extern "C" fn(idEvent: ::std::os::raw::c_int)>;
...
pub struct _FPDF_FORMFILLINFO {
    ...
    pub Release: ::std::option::Option<extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO)>,
    ...
    pub FFI_SetCursor: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, nCursorType: ::std::os::raw::c_int),
    >,
    ...
    pub FFI_KillTimer: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, nTimerID: ::std::os::raw::c_int),
    >,
    ...
    pub FFI_GetLocalTime: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO) -> FPDF_SYSTEMTIME,
    >,
    ...
    pub FFI_OnChange: ::std::option::Option<extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO)>,
    ...
    pub FFI_GetCurrentPage: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, document: FPDF_DOCUMENT) -> FPDF_PAGE,
    >,
    ...
    pub FFI_ExecuteNamedAction: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, namedAction: FPDF_BYTESTRING),
    >,
    ...
    pub FFI_DoURIAction: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_FORMFILLINFO, bsURI: FPDF_BYTESTRING),
    >,
...
pub struct _FPDF_SYSFONTINFO {
    ...
    pub Release: ::std::option::Option<extern "C" fn(pThis: *mut _FPDF_SYSFONTINFO)>,
    ...
    pub EnumFonts: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_SYSFONTINFO, pMapper: *mut ::std::os::raw::c_void),
    >,
    ...
    pub DeleteFont: ::std::option::Option<
        extern "C" fn(pThis: *mut _FPDF_SYSFONTINFO, hFont: *mut ::std::os::raw::c_void),
    >,
}
#[doc = " Interface: FPDF_SYSFONTINFO\n          Interface for getting system font information and font mapping"]
...
pub struct _IFSDK_PAUSE {
    ...
    pub NeedToPauseNow:
        ::std::option::Option<extern "C" fn(pThis: *mut _IFSDK_PAUSE) -> FPDF_BOOL>,
...
pub struct _UNSUPPORT_INFO {
    ...
    pub FSDK_UnSupport_Handler: ::std::option::Option<
        extern "C" fn(pThis: *mut _UNSUPPORT_INFO, nType: ::std::os::raw::c_int),
    >,
}
#[doc = " Interface for unsupported feature notifications."]
...
extern "C" {
    ...
    pub fn FSDK_SetTimeFunction(func: ::std::option::Option<extern "C" fn() -> time_t>);
}
extern "C" {
    ...
    pub fn FSDK_SetLocaltimeFunction(
        func: ::std::option::Option<extern "C" fn(arg1: *const time_t) -> *mut tm>,
    );
}
extern "C" {
...
pub struct _FX_FILEAVAIL {
    ...
    pub IsDataAvail: ::std::option::Option<
        extern "C" fn(pThis: *mut _FX_FILEAVAIL, offset: usize, size: usize) -> FPDF_BOOL,
    >,
}
#[doc = " Interface for checking whether sections of the file are available."]
...
pub struct _FX_DOWNLOADHINTS {
    ...
    pub AddSegment: ::std::option::Option<
        extern "C" fn(pThis: *mut _FX_DOWNLOADHINTS, offset: usize, size: usize),
    >,
}
#[doc = " Download hints interface. Used to receive hints for further downloading."]
